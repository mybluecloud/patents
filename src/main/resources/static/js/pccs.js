var cityJson = [
  ...
  {"item_code":"710000","item_name":"台湾省"},
  {"item_code":"810000","item_name":"香港特别行政区"},
  {"item_code":"820000","item_name":"澳门特别行政区"},
...
$(function(){
  ...
  $.each(cityJson, function(index,areaValue) {
    ...
    if(suffix == '0000'){
      strBufferObj.append("<option value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
    }
  });
  $("#choosePro").after(strBufferObj.toString());
...
function doProvAndCityRelation(){
  ...
  var strBufferObj = new StringBuffer();
  $.each(cityJson, function(index, areaValue){
    if(areaValue.item_code.substr(0, 2) == province.substr(0, 2) && areaValue.item_code.substr(2, 4) != '0000' && areaValue.item_code.substr(4, 2) == '00'){
      strBufferObj.append("<option value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
    }
  });
  $("#chooseCity").after(strBufferObj.toString());
}
//选择市之后生成县/区列表
function doCityAndCountyRelation(){
  ...
  $.each(cityJson, function(index, areaValue){
    var suffix = areaValue.item_code.substr(2, 4);
    if(city == '110100' || city == '120100' || city == '310100' || city == '500100'){
      if(areaValue.item_code.substr(0, 3) == city.substr(0, 3) && areaValue.item_code.substr(4, 2) !== '00'){
        strBufferObj.append("<option value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
      }
    }else{
      if(areaValue.item_code.substr(0, 4) == city.substr(0, 4) && areaValue.item_code.substr(4, 2) !== '00'){
        strBufferObj.append("<option value=\'" + areaValue.item_code + "\'>" + areaValue.item_name + "</option>");
      }
    }
  });
  $("#chooseCounty").after(strBufferObj.toString());
}